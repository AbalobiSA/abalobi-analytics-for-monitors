(function() {
    ...
    var mcsbbtController = function MonthlyCatchSpeciesByBoatTypeController(MonitorResource, SpeciesUtil, StringUtil, ResultsUtil) {
    ...
    angular.module('monthlyCatchSpeciesByBoatTypeModule')
        .component('monthlyCatchSpeciesByBoatTypeData', {
            templateUrl: 'js/monthly-catch-species-by-boat-type/monthly-catch-species-by-boat-type.template.html',
